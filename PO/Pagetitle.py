...
class PageTitle(Page):
    ...
    ipt_AssetsPage_loc = (By.XPATH, '//*[@id="app"]/section/div[1]/div/div[1]/div[2]/ul/li[7]')
    ipt_Personal_CenterPage_loc = (By.XPATH, '//*[@id="app"]/section/div[1]/div/div[2]/div[1]')
    ...
    def switch_to_Personal_CenterPage(self):
        '''切换到个人中心'''
        self.driver.find_element(*self.ipt_Personal_CenterPage_loc).click()
